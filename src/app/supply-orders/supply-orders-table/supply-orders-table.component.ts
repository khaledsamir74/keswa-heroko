...
@Component({
  selector: 'app-supply-orders-table',
  templateUrl: './supply-orders-table.component.html',
  styleUrls: ['./supply-orders-table.component.css']
})
  export class SupplyOrdersTableComponent implements OnInit, AfterViewInit {
    ...
    onCancelBtn(value: any) {
      this.sendData.emit("Cancel," + value);
    }
    onSuppliedBtn(value: any) {
      this.sendData.emit("Supplied," + value);
    }
  }
